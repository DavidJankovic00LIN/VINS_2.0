        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <AnimatedSection direction="left" delayMs={0}>
            ...
            <p className="mt-4 text-base sm:text-lg max-w-2xl text-white/90">
              Ja sam Maja, Vaš licencirani turistički vodič kroz Srbiju – zemlju bogate istorije, netaknute prirode, autentičnih ukusa i srdačnih ljudi.
            </p>
