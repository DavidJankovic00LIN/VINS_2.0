...
export default function Navigation() {
  ...
  return (
    <header className="fixed top-0 inset-x-0 z-50 bg-background/80 backdrop-blur border-b border-black/[.08] dark:border-white/[.12]">
      <nav className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex gap-6 text-sm">
          ...
          <a href="#tours" className="hover:opacity-80 transition-opacity">Tours</a>
      ...
      <div className={`md:hidden transition-all duration-300 ease-in-out overflow-hidden ${isMobileMenuOpen ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'}`}>
        <div className="bg-background/95 backdrop-blur border-t border-black/[.08] dark:border-white/[.12] px-4 py-4 space-y-3">
          ...
          <a href="#tours" className="block py-2 text-sm hover:opacity-80 transition-opacity" onClick={() => setIsMobileMenuOpen(false)}>Tours</a>
